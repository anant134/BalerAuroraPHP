CREATE TABLE `tbltouristpackage`
(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_saveregistration`
(params JSON)
BEGIN
...
SELECT registrationid, params->>'$.paymentid', now(), packageid
