             ...
             while ($row = $qr->fetch_assoc()) {
              if( $dasa["status"]=="success"){
                 ...
                 //  echo ' <p style="margin:0px">Parking Slots :'.$row["vehicle"].'</p>';
                   echo '<p style="margin:0px">Kindly PRINT or SAVE QR Code and present at the Tourism office at  Tourist Port </p>';
                   echo ' <p style="margin:0px">Thank you again, for questions and clarifications you may call  Tourism  Oﬃce   Contact Nos. 042 7881292 </p>';                         
                   echo '09100716107/09633628861/09608516791/09070201103';
                   echo '<p style="margin:0px">Or Contact  Tourism on Messenger: </p>';
                   echo '<p style="margin:0px"><a href="www.facebook.com/tourism">www.facebook.com/tourism </a></p></br>';
