...
?>
  ...
  <?php
    if (!empty($_POST)){
        ...
        $qr = excecutequery("call sp_updatepaymentreferencenumber('" .$dasa['reference_number']. "','".$dasa["regid"]."','".$qrfiles[0]["qrfilename"]."')");
        ...
        while ($row = $qr->fetch_assoc()) {
          ...
          //  echo ' <p style="margin:0px">Other Guest :'.$row["other"].'</p>';
            ...
            //     echo '<td scope="row"><div class="col-sm-3"><img src="https://maubantourism.smartpay.ph/tourbookingphp/tempdata/'.$rowqr["qrcode"].'" >  </div></td>';
            //    }
